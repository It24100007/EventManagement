            ...
            <div class="bg-white rounded-lg shadow-lg border-2 border-gray-200 p-8 mb-6">
                <div class="flex justify-between items-start mb-6">
                    <div class="flex items-center space-x-4">
                        <div class="bg-black text-white rounded-full w-20 h-20 flex items-center justify-center text-3xl">
                            <i class="fas fa-user"></i>
                        </div>
                        <div>
                            <h2 id="userName" class="text-3xl font-bold text-gray-800"></h2>
                            <p id="userEmail" class="text-gray-600 text-lg"></p>
                        </div>
                    </div>
                    <div class="flex space-x-3">
                        <button id="editBtn" class="bg-black text-white px-5 py-2 rounded-lg hover:bg-gray-800 transition duration-300 flex items-center space-x-2">
                            <i class="fas fa-edit"></i>
                            <span>Edit</span>
                        </button>
                        <button id="deleteBtn" class="bg-red-600 text-white px-5 py-2 rounded-lg hover:bg-red-700 transition duration-300 flex items-center space-x-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                        <i class="fas fa-venus-mars text-2xl text-gray-700"></i>
                        <div>
                            <p class="text-sm text-gray-500">Gender</p>
                            <p id="userGender" class="text-lg font-semibold text-gray-800"></p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                        <i class="fas fa-user-tag text-2xl text-gray-700"></i>
                        <div>
                            <p class="text-sm text-gray-500">Role</p>
                            <p id="userRole" class="text-lg font-semibold text-gray-800"></p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                        <i class="fas fa-calendar-plus text-2xl text-gray-700"></i>
                        <div>
                            <p class="text-sm text-gray-500">Created At</p>
                            <p id="userCreatedAt" class="text-lg font-semibold text-gray-800"></p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                        ...
                        <div>
                            ...
                            <p id="userUpdatedAt" class="text-lg font-semibold text-gray-800"></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-2xl m-4">
            ...
            <form id="editForm" class="space-y-4">
                ...
                <div>
                    ...
                    <select  value="User" disabled id="editRole" required
                        class=" w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-black">
